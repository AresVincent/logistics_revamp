        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="自提點/自提櫃" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="type">
              <j-dict-select-tag type="list" v-model="model.type" dictCode="self_station" placeholder="請選擇自提點/自提櫃" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="地區ID" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="areaId">
              <j-dict-select-tag type="list" v-model="model.areaId" dictCode="common_area,area,id" placeholder="請選擇地區ID" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/logistics/outlet/add",
          edit: "/logistics/outlet/edit",
          queryById: "/logistics/outlet/queryById"
        }
      }
    },
    computed: {
